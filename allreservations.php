...
<?php
  ...
  if ($_SESSION['category'] === "Customer") {
    echo '<script>
      window.location.href = "index.php";
      alert("Your are not logged in with an Employee Account.");
  </script>';
  }
...
<html>
	...
	<body>
			...
			<div class="nav-container">
				...
				<li class="nav-element-welcome">
					...
					<div class="dropdown">
						...
						<a class="in" href="allreservations.php"> All Reservations </a> </a>
						<?php endif ?>
        ...
        <!-- Body Section for All Reservations -->
        <div class="wrapper-customtable">
            ...
            <?php
                ...
                if(mysqli_num_rows($result) > 0) {
                    ...
                    echo '<div>There are currently no reservations in the system.</div>';
                }
